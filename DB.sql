...
(
    ...
    [Client_Id] [INT],
    [Origin_Price] [FLOAT],
    [Attribute_Discount] [NVARCHAR](50),
    [Note] [NVARCHAR](50),
    [Status_Invoice_Id] [INT],
    [Total_Quantity] [INT],
...
INSERT INTO Product_Details (Product_Details_Id, Color, Product_id, Quantity, Activated, Product_price)
VALUES
...
INSERT INTO Product_Images (Product_Images_Id, Name, Product_Details_Id)
VALUES
    (1, 'Image 1', 1),
    (2, 'Image 2', 2),
    (3, 'Image 3', 3),
...
INSERT INTO Type_Product (Type_Product_Id, Name, Description, Update_Day, Quantity)
VALUES
...
INSERT INTO Brands (Brand_Id, Name, Date_Created, Description, Activated)
VALUES
...
INSERT INTO Designs (Design_Id, Name, Description, Activated)
VALUES
...
INSERT INTO Product (Product_Id, Name, Description, Status, Thumnails, Total_Quantity, Brand_Id, Type_Product_Id, Category_Id, Design_Id, Updated_Time, Updated_Person_Id)
VALUES
...
INSERT INTO Category (Categories_Id, Name, Describe, Updated_Time, Updated_Person_Id)
VALUES
...
INSERT INTO Warranty (Warranty_Id, Status, Duration, Start_Date, End_Date, Activated)
VALUES
...
INSERT INTO Product_Warranly (Product_Warranly_Id, Product_Id, Warranty_Id)
VALUES
    (1, 1, 1),
    (2, 2, 2),
    (3, 3, 3),
...
INSERT INTO Invoices_Details (Invoices_Details_Id, Invoices_Id, Product_Id, Quantity, Price)
VALUES
    (1, 1, 1, 2, 50.00),
    (2, 2, 2, 3, 75.00),
    (3, 3, 3, 1, 30.00),
...
INSERT INTO Code_Coupons (Code_Coupons_Id, Code, Activated, Coupons_Id)
VALUES
    (1, 12345, 'Yes', 1),
    (2, 67890, 'Yes', 2),
    (3, 54321, 'No', 3),
...
INSERT INTO Coupons (Coupons_Id, Describe, Start_Day, End_Date, Quantity, Promotional_Type, Status, Attribute)
VALUES
...
INSERT INTO Pays (Pay_Id, Pay_Method_Id, Clent_Id, Invoice_Id, Status, Money)
VALUES
    (1, 1, 1, 1, 'Paid', 50.00),
    (2, 2, 2, 2, 'Paid', 75.00),
    (3, 3, 3, 3, 'Paid', 30.00),
...
INSERT INTO Invoices (Invoice_Id, Created_Time, Created_Person_Id, Client_Id, Origin_Price, Attribute_Discount, Note, Status_Invoice_Id, Total_Quantity, Discount_Price)
VALUES
...
INSERT INTO Users (User_Id, Name, Birthday, Gender, Phone_number, Address, Email)
VALUES
...
INSERT INTO Account (Account_Id, Username, Password, User_Id, Date_Created, Role_Id, Update_Day, Activated)
VALUES
...
INSERT INTO Status_Invoice (Status_Invoice_Id, Status)
VALUES
    (1, 'Pending'),
    (2, 'Paid'),
    (3, 'Shipped'),
...
INSERT INTO Client (Client_Id, Name, Phone_Number)
VALUES
...
INSERT INTO Pay_Method (Pay_Method_Id, Method, Status, Content)
VALUES
...
INSERT INTO Store (Store_Id, Name, Description, Address)
VALUES
